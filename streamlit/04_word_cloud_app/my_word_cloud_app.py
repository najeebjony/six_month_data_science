...
if uploaded_file:
    ...
    st.sidebar.markdown("Created by: [Najeeb ullah](https://github.com/najeebjony)")
    st.sidebar.markdown("Contact: [Email](najeebjony97@gmail.com)")

    # add a facebook , github , linkedin and twitter link to the sidebar
    st.sidebar.markdown("### Social Media Links")
    st.sidebar.markdown("[Facebook](https://www.facebook.com/Najeeb.shekih)")
    st.sidebar.markdown("[GitHub](https://github.com/najeebjony)")
    st.sidebar.markdown("[LinkedIn](https://www.linkedin.com/in/najeeb-ullah-907237142/)")
    st.sidebar.markdown("[kaggle](https://www.kaggle.com/najeebjony)")
