...
# Query text input
query_text = st.text_input('Enter your question:', placeholder='Please provide a long summary.', disabled=not uploaded_file)
...
# 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